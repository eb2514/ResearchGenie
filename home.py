...
# # Custom CSS for modern styling with light background and purple accents
# st.markdown("""
# <style>
#     @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap');
...
#     st.image(logo, width=80)
# with col2:
#     st.markdown('<div style="padding-top: 10px;"><span style="font-size: 1.5rem; font-weight: 700; color: #7B44F2;">ResearchGenie</span></div>', unsafe_allow_html=True)
# with col3:
#     st.markdown("""
#     <div style="display: flex; justify-content: flex-end; padding-top: 10px;">
#         <a href="/home" class="nav-link">Home</a>
...
# # Hero image
# # st.image("researchgenielogo.jpg", use_column_width=True)
# # Mission section
# st.markdown("<br>", unsafe_allow_html=True)
# st.markdown('<h2 class="sub-header">Our Mission</h2>', unsafe_allow_html=True)
# st.markdown("""
...
#         st.markdown(f"""
#         <div class="feature-card">
#             <div style="font-size: 2rem; color: #7B44F2; text-align: center;">{features[i]['icon']}</div>
#             <h3 class="feature-title">{features[i]['title']}</h3>
#             <p class="feature-description">{features[i]['description']}</p>
#         </div>
#         """, unsafe_allow_html=True)

# # Sign-Up Form Section (dark version to match image 2)
# st.markdown("""
# <div class="subscribe-section">
#     <h2 class="subscribe-title">Join Our Research Community</h2>
#     <p class="subscribe-subtitle">
...
#     </div>
#     <div style="text-align: center;">
#         <div style="font-weight: 600; color: #7B44F2; margin-bottom: 0.5rem;">ResearchGenie</div>
#         <p class="copyright">© 2025 ResearchGenie. All rights reserved.</p>
#     </div>
# </div>
# """, unsafe_allow_html=True)
